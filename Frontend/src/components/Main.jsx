...
const Main = () => {
    ...
    const message1 = `Hello, ${userName || 'User'}!`;  // Dynamically set greeting message
    ...
    <div className='flex-1 min-h-[100vh] pb-[15vh] bg-gray-900 relative'>
        <div className="flex items-center justify-between p-3 text-gray-300 border-b border-gray-800 bg-gray-900/80 backdrop-blur-md shadow-md">
            ...
            <div className="relative flex items-center gap-3">
                <p className="hidden sm:block text-sm text-gray-400">{greeting}, {userName || "User"}!</p>  {/* Dynamically display userName */}
                <img 
                    src={user} 
                    alt="User Avatar" 
